...
import { prayerTimes, dailyVerse, hijriDate } from "@/lib/mockData";
        ...
        <div className="px-6 space-y-6">
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <h2 className="text-3xl font-bold tracking-tight">{nextPrayer?.name}</h2>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex justify-between items-center border border-white/10">
                ...
                <div>
                   <span className="block text-xs text-primary-foreground/60 uppercase tracking-wider mb-0.5">Gregorian</span>
                   <span className="font-medium text-sm">{hijriDate.gregorian}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F8F5F1] rounded-3xl p-6 border border-[#E8E0D5] relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-4">
              ...
              <p className="font-serif text-3xl text-primary leading-relaxed dir-rtl" style={{ fontFamily: "'Amiri', serif" }}>{dailyVerse.arabic}</p>
